...
/**
 * <p>Title: ejb title </p>
 * <p>Description: t_serialnumber_emailhistory MODEL 处理类</p>
 * @author yangqinxu 电话：137****5317
 * @version 1.0 时间  2015-12-20 11:57:18
 */
@SuppressWarnings("serial")  
@Entity
@Table(name = "t_serialnumber_emailhistory")
public class SerialnumberEmailhistory   implements Serializable {
    private static final long serialVersionUID = 1L;    
    @Id
	@Column(name = "FEmailRecID")
	private String femailrecid;
	...
	@Column(name = "FToAddress")
	private String ftoaddress;
    
	@Column(name = "FFromAddress")
	...
	@Column(name = "FAattachment")
	private String faattachment;
	...
	public String getFemailrecid() {
		return femailrecid;
	}
    
	public void setFemailrecid(String femailrecid) {		     
         this.femailrecid = femailrecid;
	}
	...
	public String getFaattachment() {
		return faattachment;
	}
    
	public void setFaattachment(String faattachment) {		     
         this.faattachment = faattachment;
	}
